...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    private static final int TEXT_AREA_HEIGHT = 5, TEXT_AREA_WIDTH = 20,
            ...
            CALC_GRID_COLUMNS = 1, SEVEN = 7, FOUR = 4;
    ...
    public NNCalcView1() {
         ...
         */
        /*
         * Creates the top and bottom display using the giving dimensions
         */
        ...
        /*
         * Creates the clear, swap and enter buttons
         */
        ...
        /*
         * Creates the addition, subtraction, multiplication, division, power,
         * and root buttons and enter buttons
         */
        ...
        /*
         * Adds the 0-9 number buttons to the bDigits array
         */
        ...
        /*
         * Adds the first row of numbers 7-9, and then adds the addition button
         * to complete the first row of buttons
         */
        ...
        /*
         * Adds the second row of numbers 4-6, and then adds the subtraction
         * button to complete the second row of buttons
         */
        ...
        /*
         * Adds the third row of numbers 0-3, and then adds the multiplication,
         * power, root and division buttons to complete the third row of buttons
         * button to complete the second row of buttons
         */
        ...
        /*
         * Adds the clear, swap and enter buttons to the sideButtonPanel
         */
        ...
        /*
         * Loops through the number buttons 0-9 to add the action listener to
         * each of the buttons
         */
        for (int i = 0; i < DIGIT_BUTTONS; i++) {
    ...
    public void registerObserver(NNCalcController controller) {
        ...
        /*
         * Sets the view's controller to the NNCalcController controller
         */
    ...
    public void updateTopDisplay(NaturalNumber n) {
        ...
        /*
         * Sets the top display of the view to n
         */
    ...
    public void updateSubtractAllowed(boolean allowed) {
        /*
         * Disables or enables the subtract button depending on the boolean
         * allowed
         */
    ...
    public void updateDivideAllowed(boolean allowed) {
        /*
         * Disables or enables the divide button depending on the boolean
         * allowed
         */
    ...
    public void updatePowerAllowed(boolean allowed) {
        /*
         * Disables or enables the power button depending on the boolean allowed
         */
    ...
    public void updateRootAllowed(boolean allowed) {
        /*
         * Disables or enables the root button depending on the boolean allowed
         */
