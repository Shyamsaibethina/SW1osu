...
public final class RSSAggregator {
    ...
    private static void processItem(XMLTree item, SimpleWriter out) {
        ...
        /*
         * Checks if "url" is empty, and if so, then don't set the source name
         * to a link
         */
        if (url.equals("")) {
            out.println("   <th>" + source + "</th>");
    ...
    private static void processFeed(String url, String file, SimpleWriter out) {
        ...
        /*
         * Creates a writer for each rss feed in the feeds
         */
    ...
    public static void main(String[] args) {
        ...
        /*
         * Asks for the XML document link
         */
        out.println("XML Document of Feeds: ");
        String answer = in.nextLine();
        XMLTree tree = new XMLTree1(answer);
        out.println(tree);

        String titleOfFeeds = tree.attributeValue("title");
        ...
        SimpleWriter outFile = new SimpleWriter1L(userHTML + ".html");

        /*
         * Did not use outputHeader method because that only works for
         * individual feeds, so wrote the beginning of main HTML document in
         * this method
         */
        outFile.println("<html>");
        outFile.println("<head>");
        outFile.println("<title>" + titleOfFeeds + "</title>");
        outFile.println("</head>");
        outFile.println("<body>");
        outFile.println(" <h1>" + titleOfFeeds + "</h1>");
        outFile.println(" <ul>");

        /*
         * Goes through the children of the "feeds" document and creates the
         * HTML document for each feed, and creates an unordered list that links
         * to each feed
         */
        for (int i = 0; i < tree.numberOfChildren(); i++) {
            String name = tree.child(i).attributeValue("name");
            String url = tree.child(i).attributeValue("url");
            String file = tree.child(i).attributeValue("file");
